...
<h2 id="blanc">Choisissez votre compétition:</h2><br /><br />
<?php
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-2">
            <h5 id="blanc"><span class="txtGras">Nos competitions&nbsp;:</span><h5/>
        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="col-sm-3">
    ...
    ?>
            <div class="row">
                <div class="col-sm-12 ">
                         ...
                         <h6 id="barca"><?php print $liste[0]['TYPE_MATCH'];?></h6>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">                        
                                    ...
                                    <h3 id="blanc"><?php print $liste[$i]['NOM_MATCH'];?></h3><br/>               
                                    <h5 id="blanc"><?php print $liste[$i]['PRIX_UNITAIRE'];?>$</h5><br/> 
